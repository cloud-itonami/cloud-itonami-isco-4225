...
Open Business Blueprint for **ISCO-08 4225**: Inquiry Clerks — an ISCO
...
`:inquiry-clerks-governor` governor, human approval workflow, append-only
audit ledger). Third wave-0 cognitive batch (ADR-2607122700 addenda).
